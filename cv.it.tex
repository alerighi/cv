...
\cvitem{Amministrazione di sistema}{Amministrazione di sistemi GNU/Linux, conoscenza di tools quali systemd, iptables, LVM, container Docker/LXC, virtualizzazione, NGINX, Apache}
